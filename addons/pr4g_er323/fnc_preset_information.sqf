 ...
 *
 * Example:
 * [ARGUMENTS] call acre_pr4g_er323_fnc_preset_information
 *
 * Public: No
 */
...
for "_i" from 0 to MAX_CHANNEL do {
...
["ACRE_ER323","default",_presetData] call EFUNC(sys_data,registerRadioPreset);
