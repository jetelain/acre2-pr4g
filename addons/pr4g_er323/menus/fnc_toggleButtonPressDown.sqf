 ...
 *
 * Example:
 * [ARGUMENTS] call acre_pr4g_er323_fnc_toggleButtonPressDown
 *
 * Public: No
 */
...
private _knobImageStr = QUOTE(\z\acrefr\addons\pr4g_er323\Data\rework\er323_keyb_) + _button + QUOTE(.paa);
