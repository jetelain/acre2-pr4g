 ...
 *
 * Example:
 * [ARGUMENTS] call acre_pr4g_er328_fnc_preset_information
 *
 * Public: No
 */
...
["ACRE_ER328","default",_presetData] call EFUNC(sys_data,registerRadioPreset);
