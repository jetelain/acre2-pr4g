 ...
 *
 * Example:
 * [ARGUMENTS] call acre_pr4g_er328_fnc_toggleButtonPressDown
 *
 * Public: No
 */
...
private _knobImageStr = QUOTE(\z\acrefr\addons\pr4g_er328\Data\rework\er350_keyb_) + _button + QUOTE(.paa);
