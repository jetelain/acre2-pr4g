 ...
 *
 * Example:
 * [ARGUMENTS] call acre_pr4g_er314_fnc_toggleButtonPressDown
 *
 * Public: No
 */
...
private _knobImageStr = QUOTE(\z\acrefr\addons\pr4g_er314\Data\rework\er314_keyb_) + _button + QUOTE(.paa);
