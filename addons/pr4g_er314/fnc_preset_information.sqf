 ...
 *
 * Example:
 * [ARGUMENTS] call acre_pr4g_er314_fnc_preset_information
 *
 * Public: No
 */
...
["ACRE_ER314","default",_presetData] call EFUNC(sys_data,registerRadioPreset);
